      ...
      <div className="container">
        <div className="footer__container">
          ...
          <section className="footer__nav-section footer__nav-section--about">
            ...
            <p className="footer__nav-text footer__nav-text--about">Магазин гитар, музыкальных <br></br> инструментов и&nbsp;гитарная мастерская в&nbsp;Санкт-Петербурге.</p>
          ...
          <section className="footer__nav-section footer__nav-section--contacts">
            ...
            <p className="footer__nav-text footer__nav-text--address">г. Санкт-Петербург,<br></br> м. Невский проспект, ул. Казанская 6.</p><a className="link footer__nav-link footer__nav-link--phone" href="tel:88125005050">8-812-500-50-50</a>
